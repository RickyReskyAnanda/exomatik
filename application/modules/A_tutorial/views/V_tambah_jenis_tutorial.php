                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div>
                                <div class="ibox-content">
                                    <form action="<?=base_url('admin/tutorial/jenis/insert')?>" method="post">
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="form-group"><label class="col-sm-2 control-label">Nama Jenis Tutorial</label>
                                                <div class="col-sm-10"><input type="text" name="nama_jenis_tutorial" class="form-control" placeholder="Masukkan Nama Jenis Tutorial">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="form-group"><label class="col-sm-2 control-label">Keterangan</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="keterangan" placeholder="Masukkan keterangan" maxlength="250" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-bottom: 10px;">
